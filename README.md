...
| Project | Description | Language |
|---------|-------------|----------|
| [llama-ai](https://github.com/fewtarius/llama-ai) | A simple script repository that automates using local LLMs on my personal AMD devices | Shell |
...
| [SteamForkTools](https://github.com/fewtarius/SteamForkTools) | A simple installation helper. | Shell |
| [SteamOS-Waydroid-Installer](https://github.com/fewtarius/SteamOS-Waydroid-Installer) | Script to easily install / uninstall Android via Waydroid on the Steam Deck running on SteamOS. | Shell |
| [steamfork-sddm](https://github.com/fewtarius/steamfork-sddm) | SDDM theme for SteamFork desktop mode. |  |
| [distributionhub.github.io](https://github.com/fewtarius/distributionhub.github.io) | A handy website that allows you to download all Linux distributions in one place with one click. | JavaScript |
| [steamdeck-discord-status](https://github.com/fewtarius/steamdeck-discord-status) | SteamDeck Homebrew Plugin for displaying current game in Discord | TypeScript |
| [DeckyPlumber](https://github.com/fewtarius/DeckyPlumber) | Experimental Decky Plugin for InputPlumber | TypeScript |
| [HandyGCCS](https://github.com/fewtarius/HandyGCCS) | Handheld Game Console Controller Support (Handy Geeks) for Linux  | Python |
